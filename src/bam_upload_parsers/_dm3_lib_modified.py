...
class DM3:
    ...
    def _readTagEntry(self):
        ...
        if debugLevel > 5:
            print(f"{self._curGroupLevel}|{self._makeGroupString()}:", end=" ")
    ...
    def _readStructTypes(self):
        ...
        for i in range(nFields):
            ...
            if debugLevel > 9:
                print(f"{i}th nameLength = {nameLength}")
    ...
    def dumpTags(self, dump_dir="/tmp"):
        ...
        try:
            ...
            for tag in self._storedTags:
                dumpf.write(f"{tag.encode(self._outputcharset)}\n")
            dumpf.close
    ...
    def info(self):
        ...
        info_keys = {
            ...
            "OperatingMode": "%s.ImageTags.Microscope Info.Illumination Mode"
            % tag_root,
            "ProjectorMode": "%s.ImageTags.Microscope Info.Operation Mode" % tag_root,
            "CameraLength": "%s.ImageTags.Microscope Info.STEM Camera Length"
            % tag_root,
